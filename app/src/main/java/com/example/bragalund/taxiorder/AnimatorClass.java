...
public class AnimatorClass {
    ...
    //Source: http://kunmii.blogspot.no/2014/04/how-to-create-easy-android-textview.html
    //Date: 05.05.2017, 20:11PM
    //Inspired by: Olakumni Joseph
    ...
    public AnimatorClass(TextView textView, String[] textList) {
        this(textView, 700, 1000, 2000, textList);
    }

    public AnimatorClass(TextView textView, int fadeEffectDuration, int delayDuration, int displayLength, String[] textList) {
    ...
    private void InnitializeAnimation() {
        ...
        fadeiInAnimationObject.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                textView.startAnimation(textDisplayAnimationObject);
            }
        });
        ...
        fadeOutAnimationObject.setAnimationListener(new Animation.AnimationListener() {
            ...
            @Override
            public void onAnimationEnd(Animation animation) {
                textView.startAnimation(delayBetweenAnimations);
            }
        });
        delayBetweenAnimations.setAnimationListener(new Animation.AnimationListener() {
            ...
            @Override
            public void onAnimationEnd(Animation animation) {
                textView.startAnimation(fadeiInAnimationObject);
            }
        });
    }
